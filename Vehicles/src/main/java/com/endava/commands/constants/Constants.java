package com.endava.commands.constants;
...
public class Constants {
  ...
  public static final String VEHICLE_CREATED_MESSAGE = "Vehicle of type %s was created.";
  public static final String VEHICLE_EXIST_MESSAGE = "Vehicle with number %s is already registered in the system.";
  ...
  public static final String PARKING_TICKET_CREATED_MESSAGE = "%s entered parking at %s.";
  public static final String PARKING_TICKET_PRICE = "Sum to pay: %.2f";
