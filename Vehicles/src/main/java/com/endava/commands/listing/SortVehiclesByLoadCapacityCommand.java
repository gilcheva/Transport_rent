...
public class SortVehiclesByLoadCapacityCommand implements Command {
  ...
  public SortVehiclesByLoadCapacityCommand(VehiclesRepository repository) {
  ...
  private String printSortedExecute() {
    List<Vehicle> sorted = repository.sortedByLoadCapacity();
    StringBuilder sb = new StringBuilder();
    sb.append(System.lineSeparator());
    sb.append(JOIN_DELIMITER).append(JOIN_DELIMITER).append(System.lineSeparator());
    sb.append("-----------  Vehicles Sorted By Load Capacity  ----------").append(System.lineSeparator());
    for (Vehicle vehicle : sorted) {
      sb.append(vehicle.toString()).append(System.lineSeparator());
    }
    sb.append("------------- End of sort by load capacity ---------------").append(System.lineSeparator());
    sb.append(JOIN_DELIMITER).append(JOIN_DELIMITER).append(System.lineSeparator());
    return sb.toString();
  }
