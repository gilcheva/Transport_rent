...
public class CreateBusParkingCommand implements Command {
  ...
  public CreateBusParkingCommand(VehiclesFactory factory, VehiclesRepository repository) {
  ...
  public String execute(List<String> parameters) {
    ...
    Parking busParking = factory.createBusParking(name, capacity, hourlyRate);
    addParking(busParking);
    return String.format(PARKING_CREATED_MESSAGE, busParking.getParkingType(), busParking.getName());
  }
  ...
  private void parseParameters(List<String> parameters) {
    try {
      ...
      throw new IllegalArgumentException("Failed to parse CreateBusParking command parameters.");
    }
  }
